...
def aa(in_dir, img_file1, img_file2, img_file3, label_file, out_dir):
    ...
    cam1 = r"C:\Users\zpl\Desktop\MVS\dataset\xuzhou3\test02\image\029519.cam"
    cam2 = r"C:\Users\zpl\Desktop\MVS\dataset\xuzhou3\test03\image\030517.cam"
    cam3 = r"C:\Users\zpl\Desktop\MVS\dataset\xuzhou3\test02\image\030518.cam"
    ...
    for file in files:
        ...
        x3_l = out3[0].x
        y3_l = out3[0].y
        ref_txt = r"C:\Us-ers\zpl\Desktop\xuzhou3_n\test04\data\cam\3051.txt"
        ...
        crop_image(label_file, out_label, x3_l, y3_l, w, h, True, 1, 'nearest', 768, 384, ot="Byte")
        # sys.exit()


if __name__ == '__main__':
    in_dir = r"C:\Users\zpl\Desktop\MVS\dataset\xuzhou3\test03\crop\DOM"
    ...
    label_file = r"C:\Users\zpl\Desktop\b\mask03.tif"
    out_dir = r"C:\Users\zpl\Desktop\b\03\out"
